...
export class Player {
    ...
    update(input, deltaTime) {
        ...
        //    horizontal movement
        this.x += this.speed;
        if (input.includes('ArrowRight')&&this.currentStates!==this.states[6]) this.speed = this.maxSpeed;
        else if (input.includes('ArrowLeft')&&this.currentStates!==this.states[6]) this.speed = - this.maxSpeed;
        else this.speed = 0;
