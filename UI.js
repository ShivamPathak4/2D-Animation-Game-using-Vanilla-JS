    ...
    draw(context) {
        ...
        if (this.game.gameOver) {
            ...
            if (this.game.score >this.game.winningScore) {
                ...
                context.fillText('Press  "spacebar"  to Replay', this.game.width * 0.5, this.game.height * 0.5 + 60);
                ...
                context.fillText('Loved at first bite?', this.game.width * 0.5, this.game.height * 0.5 - 20);
                context.font = this.fontSize * 0.7 + 'px ' + this.fontFamily;
