...
export class Diving extends States {
    ...
    handleInput(input) {
        ...
        if (this.game.player.onGround()) {
            this.game.player.setStates(states.RUNNING, 1);
            for(let i=0;i<30;i++){
                this.game.particles.unshift(new Splash(this.game,this.game.player.x+this.game+this.game.player.width*0.5,this.game.player.y+this.game.player.height));
            }
